...
from .typing.extension import MISSING, Missing, resolve_instance_classname
from .metaclass.metabase import ReadonlyAttr
...
def make_params_hashable(
    ...
    return hash_cache if hash_cache.hash_value is not MISSING else MISSING
