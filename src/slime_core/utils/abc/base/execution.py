...
class CoreBaseGeneratorQueue(CoreBaseList[_BaseGeneratorT], ABC, Generic[_BaseGeneratorT]):
    """
...
class CoreContextManagerStack(CoreBaseList[ContextManager[_EnterT_co]], ABC, Generic[_EnterT_co]):
    """
